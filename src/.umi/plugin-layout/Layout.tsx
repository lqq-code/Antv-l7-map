...
export default props => {
  ...
  const userConfig = {
    ...{'name':'antv-l7','theme':'PRO','locale':true,'showBreadcrumb':true,'siderWidth':208,'navTheme':'light','primaryColor':'#2952EC','layout':'mix','contentWidth':'Fluid','fixedHeader':false,'fixSiderbar':true,'colorWeak':false,'title':'Map','pwa':false,'iconfontUrl':''},
    ...runtimeConfig || {}
  };
